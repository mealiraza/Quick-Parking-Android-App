...
public class SuppourtCenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suppourt_center);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(problem.isEmpty()){
                    ...
                    AlertDialog submitAlert= new AlertDialog.Builder(SuppourtCenter.this)
                            ...
                            .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    final ProgressDialog progressDialog=new ProgressDialog(SuppourtCenter.this);
                                        ...
                                        public void onComplete(DatabaseError error, DatabaseReference ref) {
                                            ...
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    AlertDialog successAlert=new AlertDialog.Builder(SuppourtCenter.this)
                                                            .setCancelable(false)
